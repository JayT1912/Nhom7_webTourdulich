...
using Nhom7_webTourdulich.Services; // Namespace chứa EmailSender
...
builder.Services.AddAuthorization(options =>
{
    options.AddPolicy("AdminOrManagePolicy", policy =>
        policy.RequireRole("Admin")); // Admin and Manager roles
});

// Cấu hình dịch vụ Authorization (phân quyền)
builder.Services.AddAuthorization(options =>
{
